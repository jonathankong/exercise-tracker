...
//TODO Merge Edit and Create exercise components
export default class EditExercise extends Component{
    ...
    async getExercise() {
        const res = await axios.get('http://localhost:5000/exercises/'+this.props.match.params.id);
        this.setState({
